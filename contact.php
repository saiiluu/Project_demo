...
?>
       ...
       <div class="row">
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    Sinhgad College Of Arts,Commerce And Science,<br>Katraj-Dehu Road Bypass,<br>Ambegaon Bk,Pune,Maharashtra 411041<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: +91 44 3993 1555</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="mailto:name@example.com">sinhgadinstitute@university.in</a>
                </p>
